...
export const translations = {
  es: {
    ...
    worldReport: {
      ...
      patienceNote: "Esto puede tardar varios minutos (217 estaciones × ~20-25 años de clima histórico cada una). Podés navegar a otras secciones — el progreso sigue solo.",
  ...
  en: {
    ...
    worldReport: {
      ...
      patienceNote: "This can take several minutes (217 stations x ~20-25 years of historical weather each). You can navigate to other sections - progress keeps running.",
